$(document).ready(function () {
    ...
    $("#BranchID").change(function () {
        ...
        if (BranchID.length === 0) {
            ...
            $.ajax({
                type: "GET",
                url: "/B_AddCostAccountToAccount/GetBranchName?BranchID=" + BranchID,
    ...
    // Get Accounts that related to this Branch that related to company to the chart
    function GetBranchAccounts(BranchID) {

        $.ajax({
            type: "GET",
            url: "/B_AddCostAccountToAccount/GetAccountDist?BranchID=" + BranchID,
    ...
    $("#AccountID").change(function () {
        ...
        if (AccountID.length === 0) {
            ...
            $.ajax({
                type: "GET",
                url: "/B_AddCostAccountToAccount/GetAccountName?AccountID=" + AccountID,
                success: function (result) {
                    ...
                    if (result.CostCenterType == "CostCenter") {
                        ...
                        if (result.R_CostCenterID == "") {
                            $("#GlobalError").text("No Cost Center ID Choosen To This Account go To Update This Account..").append("<p><a href='/B_CreateAccount/BranchAccount'>Branch Create Account</a></p>");
                        } else {
                            $("#GlobalError").text("");
                    ...
                    // if Type of Account -> Main Cost Center
                        ...
                        if (result.R_CostCenterGroupID == "") {
                            $("#GlobalError").text("No Main Cost Center ID Choosen To This Account go To Update This Account..").append("<p><a href='/B_CreateAccount/BranchAccount'>Branch Create Account</a></p>");
                        } else {
                            $("#GlobalError").text("");
                        ...
                        $("#GlobalError").text("No Main OR Cost Center ID Choosen To This Account go To Update This Account..").append("<p><a href='/B_CreateAccount/BranchAccount'>Branch Create Account</a></p>");
                    }
                }
            });
        }
    ...
    function GetCostCenterAccounts(CostCenterID) {
        ...
        $.ajax({
            type: "GET",
            url: "/B_AddCostAccountToAccount/GetCostCenterAccounts?CostCenterID=" + CostCenterID,
            success: function (data) {
                $("#CostAccountID").empty();
    ...
    $("#CostAccountID").change(function () {
        ...
        if (CostAccountID.length == 0) {
            ...
            $.ajax({
                type: "GET",
                url: "/B_AddCostAccountToAccount/GetCostAccountName?CostAccountID=" + CostAccountID,
                success: function (result) {
    ...
    $("#AddCCAccountbtn").click(function () {
        ...
        $(".BranchCostAccPerTbl").each(function () {
            var value = $(this).text();
        ...
        if (Test === true) {
            ...
            $.ajax({
                type: "POST",
                url: "/B_AddCostAccountToAccount/AddCostAccountTypeCC?AccountID=" + AccountID + "&CostCenterID=" + CostCenterID + "&CostAccountID=" + CostAccountID + "&Percentage=" + Percentage + "&Type=" + Type + "&AccountChartID=" + AccountChartID,
                success: function (result) {
    ...
    function GetCostAccountsData(AccountID, CostCenterID, Type, AccountChartID) {
        ...
        $.ajax({
            type: "GET",
            url: "/B_AddCostAccountToAccount/GetCostAccounts?AccountID=" + AccountID + "&CostCenterID=" + CostCenterID + "&Type=" + Type + "&AccountChartID=" + AccountChartID,
            success: function (result) {
                ...
                for (var i = 0; i < result.length; i++) {
                    ...
                    var Data = "<tr class='row_" + result[i].ID + "'>" +
                        ...
                        "<td class='BranchCostAccPerTbl'>" + result[i].Percentage + "</td>" +
    ...
    function GetMainCostCenterID(CostCenterGroupID) {
        ...
        $.ajax({
            type: "GET",
            url: "/B_AddCostAccountToAccount/GetMainCostCenterID?CostCenterGroupID=" + CostCenterGroupID,
            success: function (data) {
                $("#CostCenterIDFromMain").empty();

                $("#CostCenterNameFromMain").text("");
    ...
    $("#CostCenterIDFromMain").change(function () {
        ...
        if (CostCenterIDFromMain.length === 0) {
            ...
            $.ajax({
                type: "GET",
                url: "/B_AddCostAccountToAccount/GetCostCenterIDData?CostCenterIDFromMain=" + CostCenterIDFromMain + "&MainCostCenterID=" + MainCostCenterID,
                success: function (result) {
    ...
    function GetCostCenterAccountsFromMain(CostCenterIDFromMain) {
        ...
        $.ajax({
            type: "GET",
            url: "/B_AddCostAccountToAccount/GetCostCenterAccounts?CostCenterID=" + CostCenterIDFromMain,
            success: function (data) {
                $("#CostAccountIDFromMain").empty();
...
function CompConfirmDelete() {
    ...
    $.ajax({
        type: "POST",
        url: "/B_AddCostAccountToAccount/DeleteCostAccountComp?CostAccountID=" + CostCenterAccountID,
        success: function (result) {
