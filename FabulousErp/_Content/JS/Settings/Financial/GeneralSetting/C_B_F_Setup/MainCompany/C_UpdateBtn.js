function CUpdateBtn() {
    ...
    if (Check.length > 0 || Check2.length > 0) {
        ...
        /*
        if (CompanyAlies.length == 0) {
            $("#ECompanyAlies").text("Company Alies Is Required");
            $("#CompanyAlies").focus();
        } else { $("#ECompanyAlies").text(""); }
        */
        ...
        if (EstablishDate.length == 0) {
            $("#EEstablishDate").text("Establish Date Is Required");
            $("#EstablishDate").focus();
        } else { $("#EEstablishDate").text(""); }
        */
        ...
        /*
        if (CommericalOffice.length == 0) {
            $("#ECommericalOffice").text("Commerical Office Is Required");
            $("#CommericalOffice").focus();
        } else { $("#ECommericalOffice").text(""); }
        */
        ...
        if (TaxOffice.length == 0) {
            $("#ETaxOffice").text("Tax Office Is Required");
            $("#TaxOffice").focus();
        } else { $("#ETaxOffice").text(""); }
        */
        ...
        var ECompanyName = $("#ECompanyName").text();
        //var ECompanyAlies = $("#ECompanyAlies").text();
        var ECountryName = $("#ECountryName").text();
        var ELanguage = $("#ELanguage").text();
        var ECurrency = $("#ECurrency").text();
        var ECompanyMainActivity = $("#ECompanyMainActivity").text();
        ...
        var ECompanyType = $("#ECompanyType").text();
        // var EEstablishDate = $("#EEstablishDate").text();
        var ECommericalRegister = $("#ECommericalRegister").text();
        // var ECommericalOffice = $("#ECommericalOffice").text();
        var ETaxFileNo = $("#ETaxFileNo").text();
        ...
        var WebsiteError = $("#WebsiteError").text();

        if (ECompanyName.length == 0 && ECountryName.length == 0 && ELanguage.length == 0 && ECurrency.length == 0 && ECompanyMainActivity.length == 0 &&
            EStreetName.length == 0 && EBuldingNo.length == 0 && EFloorNo.length == 0 && EGovernorate.length == 0 &&
            ECompanyType.length == 0 && ECommericalRegister.length == 0 && ETaxFileNo.length == 0 &&
            ...
            EFax5.length == 0 && EFaxEX5.length == 0 && WebsiteError.length == 0) {
            ...
            $.ajax({
                type: "GET",
                url: "/MainCompany/CheckChanges?CompanyID=" + CompID,
                success: function (data) {
                    ...
                    if (data.CompanyAlies == null) {
                        NCompanyAlies = "";
                    } else { NCompanyAlies = data.CompanyAlies; }
                    ...
                    if (CompanyName == data.CompanyName && CompanyAlies == NCompanyAlies && EstablishDate == NEstablishDate && StreetName == data.StreetName &&
                        BuldingNo == data.BuldingNo && FloorNo == NFloorNo && Area == NArea && City == NCity && Governorate == data.Governorate &&
                        International1 == NInternational1 && Telephone1 == NTelephone1 &&
                        ...
                        && Code4 == NCode4 && Fax4 == NFax4 && FaxEX4 == NFaxEX4 && Code5 == NCode5 && Fax5 == NFax5 && FaxEX5 == NFaxEX5 &&
                        CountryName == data.CountryName && Language == data.Language && CompanyMainActivity == data.CompanyMainActivity &&
                        CompanyType == data.CompanyType && CommericalRegister == data.CommericalRegister && CommericalOffice == data.CommericalOffice
                        && TaxFileNo == data.TaxFileNo && TaxOffice == data.TaxOffice && VatID == data.VatID && TaxVaOffice == data.TaxVaOffice &&
                        ImporterID == data.ImporterID && ImportOffice == data.ImportOffice && ExportID == data.ExportID && ExportOffice == data.ExportOffice
                        && SocialInsuranceID == data.SocialInsuranceID && SocialInsuranceOffice == data.SocialInsuranceOffice && Website == data.Website
                        && InputLogo.length === 0 && InputCommerical.length === 0 && InputTax.length === 0 && InputVat.length === 0 && InputImport.length === 0 &&
                        InputExport.length === 0 && InputInsurance.length === 0 && Status == data.Status) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "/MainCompany/UpdateCompanyInfo?CompanyID=" + CompID + "&CompanyName=" + CompanyName + "&CompanyAlies=" + CompanyAlies + "&CountryName=" + CountryName
        ...
        $("#UpdateWithoutSearch2").text("Pleas Fill Company ID To Search");
