function FUpdateBtn()
{
    ...
    if (Check.length > 0 || Check2.length > 0) {
        ...
        if (FactoryName.length == 0) {
            $("#EFactoryName").text("Factory Name Is Required");
            $("#FactoryName").focus();
        } else { $("#EFactoryName").text(""); }
        ...
        var EFactoryName = $("#EFactoryName").text();
        ...
        if (EFactoryName.length == 0 && EStreetName.length == 0 && EBuldingNo.length == 0 && EFloorNo.length == 0 && EGovernorate.length == 0 &&
            ...
            var FactoryAlies = $("#FactoryAlies").val();
            ...
            $.ajax({
                type: "GET",
                url: "/CompanyFactory/CheckChanges?FactoryID=" + FactoryID,
                success: function (data) {
                    ...
                    if (data.FactoryAlies == null) {
                        NFactoryAlies = "";
                    } else { NFactoryAlies = data.FactoryAlies; }
                    ...
                    if (FactoryName == data.FactoryName && FactoryAlies == NFactoryAlies && EstablishDate == NEstablishDate && StreetName == data.StreetName &&
                        ...
                        $.ajax({
                            type: "POST",
                            url: "/CompanyFactory/UpdateFactoryInfo?FactoryID=" + FactoryID + "&FactoryName=" + FactoryName + "&FactoryAlies=" + FactoryAlies + "&StreetName=" + StreetName + "&BuldingNo=" + BuldingNo + "&FloorNo=" + FloorNo
        ...
        $("#UpdateWithoutSearch2").text("Pleas Select Company ID Then Fill Factory ID To Search");
