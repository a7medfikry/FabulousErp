...
namespace FabulousModels.DTOModels.Settings.Financial.GeneralSettings.C_B_F_Setup.CompanyFactoryInfo
{
    public class R_Company_Info_DTO
    {
        //Branch Main Info
