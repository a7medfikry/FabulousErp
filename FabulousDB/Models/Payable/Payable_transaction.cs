...
{
    public class Payable_transaction
    {
        ...
        [DefaultValue(false)]
        [DisplayName("Fixed Assets Trx")]
        public bool Fixed_assets_trx { get; set; }
        ...
        [NotMapped]
        public virtual Payable_void Payable_void { get; set; }
        [NotMapped]
        public decimal Applay_asign_taken_discount { get; set; }
        public virtual ICollection<Inv_receive_po> Purchase_invoice { get; set; }
