...
namespace FabulousErp.Payable.Models
{
    public class Payable_payment
    {
        ...
        public Payable_transaction Tranaction {get;set; }
        [ForeignKey("Transaction_p_id")]
        public Payable_transaction Tranaction_pay { get;set;}
        ...
        [NotMapped]
        public decimal ReciptAmount { get; set; } = 0;
        [NotMapped]
