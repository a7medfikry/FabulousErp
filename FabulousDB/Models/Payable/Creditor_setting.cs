...
{
    public class Payable_creditor_setting
    {
        ...
        public Payable_shipping_method Shippint_method { get; set; }
        public Payable_Group_setting Group_setting { get; set; }
        ...
        public virtual ICollection<Payable_creditor_currencies> Vendore_currencies { get; set; }
        public virtual ICollection<Payable_legal_info> Payable_legal_info { get; set; }
        public virtual ICollection<Payable_address_info> Payable_address_info { get; set; }
